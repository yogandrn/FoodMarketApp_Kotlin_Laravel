<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="" style="margin-left: 0.5rem; margin-bottom:1.5rem;">
                        ...
                        @forelse($users as $item)
                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4 text-center" >
                                    <a href="{{ route('users.show', $item->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded" >
                                        See
                                    </a>
